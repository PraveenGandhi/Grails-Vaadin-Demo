...
<v:location name="body">
	...
	<div id="edit-employee" class="content scaffold-edit" role="main">
		...
		<div>
			<v:verticalLayout>
				<v:form var="editForm" bean="${employeeInstance}" writeThrough="false" invalidCommitted="true">
	...
	<div class="buttons toolbar">
		<v:horizontalLayout spacing="false">
			<v:link icon="images/skin/database_save.png" action="update" instance="${employeeInstance}" onclick="${v.commit(form:'editForm')}"><g:message code="default.button.update.label"/></v:link>
