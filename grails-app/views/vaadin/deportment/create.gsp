...
<v:location name="body">
	...
	<div id="list" class="content scaffold-create" role="main">
		...
		<div>
			<v:verticalLayout>
				<v:form var="createForm" bean="${deportmentInstance}" writeThrough="false" invalidCommitted="true">
	...
	<div class="buttons toolbar">
		<v:horizontalLayout spacing="false">
			<v:link icon="images/skin/database_add.png" action="save" instance="${deportmentInstance}" onclick="${v.commit(form:'createForm')}"><g:message code="default.button.create.label"/></v:link>
		</v:horizontalLayout>
	</div>
</v:location>
</v:layout>
